...
export default function DashboardPage() {
    const { user } = useAuth();
    const router = useRouter(); // Remplacé: useNavigate() -> useRouter()
                ...
                <div className="space-y-3">
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 p-4">
                        <SectionHeader
                            ...
                            icon={ShieldAlert}
                            onNavigate={() => router.push('/alerts')} // Remplacé
                        />
                                    ...
                                    {myNotifs.map(n => (
                                        <div key={n.id} className="px-4 py-2.5 flex items-start justify-between gap-3 hover:bg-gray-50/50">
                                            ...
                                            <div className="flex items-center gap-1.5 shrink-0 pt-0.5">
                                                {n.relatedIncidentId && (
                                                    <button
                                                        onClick={() => router.push('/incidents')} // Remplacé
                ...
                <div className="space-y-3">
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 p-4">
                        <SectionHeader
                            ...
                            icon={FileWarning}
                            onNavigate={() => router.push('/incidents')} // Remplacé
                        />
                ...
                <div className="space-y-3">
                    <div className="bg-white rounded-xl border border-gray-100 p-4">
                        <SectionHeader
                            ...
                            icon={MonitorCheck}
                            onNavigate={() => router.push('/agents')} // Remplacé
                        />
